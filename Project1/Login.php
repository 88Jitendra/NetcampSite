...
<h1>Student <span class="yellow">Login</span></h1>
 <form class="form-horizontal" role="form" action="login_backend.php" method="POST" name="loginform">
                <div class="form-group">
                  <label for="inputPassword3" class="col-sm-4 control-label">Login<span class="star">*</span></label>
                  <div class="col-sm-4">
                    <div class="input-group">
                    <input type="text" class="form-control custom-input" id="inputPassword3" name="x" placeholder="Registration No. or Email" required>
	 ...
	 <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <div class="input-group">
                    <input type="password" class="form-control custom-input" id="inputPassword3" name="y" placeholder="Enter Password" required>
