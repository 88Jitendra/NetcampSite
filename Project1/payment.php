...
<ul >
 ...
 <strong>Choose your choice</strong>
 <ol class="raw text-center">
  <li><a href="netbank.php">By Netbanking</a></li>
  <li><a href="debit.php">By Debitcard</a></li>
  <li><a href="last.php">Skip for payment done by paytm</a></li>
  </ol>
  </div>
 </body>
 </html>
